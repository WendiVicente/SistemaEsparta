    ...
    public partial class CuentaPorCobrar : BaseContext
    {
        ...
        private void btnCrearCuenta_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    MessageBox.Show("No se puede crear cuenta, por que no hay \nun cliente seleccionado.", "Advertencia");
                }                
            }
            catch
            {
                MessageBox.Show("Es posible que aun no se puedan crear cuentas.", "ERROR");
            }            
        }
