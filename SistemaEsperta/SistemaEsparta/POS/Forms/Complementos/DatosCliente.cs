...
namespace POS.Forms
{
    public partial class DatosCliente : BaseContext
    {
        ...
        {
            var cliente = _clientesRepository.GetClienteByNitandNombre(txtNit.Text.Trim(), txtNombre.Text.Trim());
            if (cliente != null)
            {
            ...
            try
            {
                ...
                if (cliente == null)
                {
                    ...
                    else
                    {
                        ...
                        _clientesRepository.Add(_cliente);
                        _cliente = _clientesRepository.GetClienteByNitandNombre(txtNit.Text.Trim(), txtNombre.Text.Trim()); 
                        CrearCuentabyCobrar(_cliente.Id);
                        _pos._cliente = _cliente;
                    }                    
        ...
        public string CodigoCliente()
        {
            ...
            return ObtenerNumero(cliente, "CL-");
        }
